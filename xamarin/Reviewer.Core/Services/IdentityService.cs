...
namespace PhotoTour.Core
{
	...
	{
		static readonly string Tenant = "azuredevtour.onmicrosoft.com";
		static readonly string ClientID = "50ca036b-6a7f-4933-9a34-9161b5bdd3f3";
		static readonly string SignUpAndInPolicy = "B2C_1_SignInUp";
		...
		static readonly string[] Scopes = { "https://azuredevtour.onmicrosoft.com/backend/upload_photo" };
